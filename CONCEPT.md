...
| 3 — Design | [concept/phase-3.md](concept/phase-3.md) | Match loop, Commander system, 3 civilizations (Greek/Aztec/Norse — each with 6 towers + 5 units + 6 T4 Demigods + 3 Gods), 3 launch commanders (Leonidas / Montezuma II / Ragnar Lothbrok), 6-mode launch roster (Solo Campaign / Horde-A / Horde-B / PvE-MP / PvP-IW / PvP-Maze), meta systems, audio, first-run. |
...
- **Go big at launch.** MVP ships the full content skeleton (3 civs × full ladder + 3 Gods via 9 Fusion recipes + 6 launch modes). Cuts go to post-launch content, never to the launch skeleton ([phase-7.md §7.4](concept/phase-7.md#74-notes-to-future-self)).
