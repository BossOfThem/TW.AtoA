...
**Amendment banner — 2026-04-26 real-cultures frame cascade (stage-level, stub).** Per [`decisions/2026-04-25-q2-real-cultures-direction-ratified.md`](../decisions/2026-04-25-q2-real-cultures-direction-ratified.md) (Reversibility **Hard**) + [`decisions/2026-04-26-phase-1-exit-one-pager.md`](../decisions/2026-04-26-phase-1-exit-one-pager.md) — the 3-lineage Ash/Nature/Prayer framing under the prior 2026-04-21 amendment is **superseded** by **3 civilizations (Greek / Aztec / Norse) + 3 launch commanders (Leonidas / Montezuma II / Ragnar Lothbrok)**. Roster remains 3. Gallery surfaces **civilization affinity** (Greek/Aztec/Norse) instead of lineage tilt. Lineage-color accent maps to civilization palette TBD. "Tilt-not-cage" §12 copy discipline **does not apply** under real-cultures: civilization is a stronger cage than lineage was — a Greek commander fields Greek towers only (cross-civ borrowing is parked as post-launch Foresight-coin per 2026-04-25 Follow-up #7). Silhouettes are civ-coded per the re-rebased [`decisions/2026-04-20-commander-pick-identity-upgrade.md`](../decisions/2026-04-20-commander-pick-identity-upgrade.md), and specifics are **gated by cultural-sensitivity pass** (2026-04-25 Follow-up #5) — Aztec silhouette especially must clear external review. All commander names this stage uses as placeholders (Warmother / Scholar-exile / etc.) are superseded by the locked trio; §5.4 naming **conventions [LOCKED]** remain untouched. Accessibility floor §2.4a [LOCKED] untouched. **Verification V1–V7** inherit verbatim — the silhouette-readability V5 and re-pick-rate V7 metrics are if anything more load-bearing under real-cultures because the civ-cage means a wrong first-pick is costlier. The 2026-04-21 sub-banner below stays as historical record; body rewrite belongs to a dedicated Stage 01 reopen pass, not this cascade.
