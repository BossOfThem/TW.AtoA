...
*Document version: 0.43 — 2026-05-05: Numbers-phase Round 6 LANDED — Commander (h) ability magnitudes (damage-variant baseline floor): passive +15% / 2-cell civ-gated aura; active 4× T3 DPS / 3-cell / 4s / 30s CD (2,880 burst); signature once-per-match free tier-up T1→T2 or T2→T3. 1 new decision document. Control/summon/economy variants deferred to per-commander authoring sub-pass post-Round 10. cascade-lint pending. §2.4a + §5.4 [LOCKED] + 17-item frame untouched. Prior: 0.42 — 2026-05-05: Round 5 (tower baselines + tier costs) landed. [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
