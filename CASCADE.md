...
**2026-04-24 — Phase 1 vision reopen ratified by PM (no doc edits this session).** Bootstrap + concept discussion. PM confirmed full concept rehaul: supersedes 2026-04-21 (3/3/3 + dungeon cosmology + Ash-enabler, Reversibility Hard). Thematic direction: synthetic mythic-history braid. Age model deferred pending story/background groundwork. Step B prototype-reshape plan (Proposed) downstream of rehaul. First artifact next session: `decisions/2026-04-24-phase-1-vision-reopen-synthetic-mythic-history.md`. Then Socratic discovery Q2–Q10, one per turn. LOCKED items unchanged: §2.4a accessibility floor, §5.4 naming conventions, mechanics surface. HANDOFF + PROGRESS updated this commit. CASCADE doc version v0.17 → v0.18.
...
|------|----------|---------------|
| 2026-04-21 | [Concept tightening: 3/3/3 shape + dungeon cosmology + Ash-enabler hybrids](decisions/2026-04-21-concept-tightening-3x3x3-dungeon-cosmology.md) | **Hard** |
...
| 2026-04-22 | [Step B: Prototype reshape plan — 3/3/3 cascade into prototype data + scenes + lint + docs (Proposed)](decisions/2026-04-22-step-b-prototype-reshape-plan.md) | Medium |
