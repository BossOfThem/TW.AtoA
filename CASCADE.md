...
*Document version: 0.35 — 2026-05-04: C4-continuation polish LANDED (commit `c45cb00`, +64 lines `prototype/index.html`: action-bar attack-type stamp + merge-preview ghost on hover-existing-tower + Promote-T4 inline indicator on T3 hexes) + Follow-up #4 closed (commit `2e56cf5`: Aztec glyph 𓁹 → ◈ abstract placeholder, decision `2026-05-04-aztec-glyph-abstract-placeholder.md` Accepted/Easy, cultural-sensitivity gate Follow-up #5 preserved). cascade-lint clean. §2.4a + §5.4 [LOCKED] untouched. Prior: 0.34 — 2026-05-03: C6 slice 2 LANDED (graduation cut: legacy 5-lineage / 11-age teardown). [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
