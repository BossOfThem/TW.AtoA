...
*Document version: 0.52 — 2026-05-05: CONCEPT amendment pass Round 5 LANDED — phase-4 §4.6 Economy rewritten in-place (Tribute kill-only curve + Divinity 6-source 4-floor+2-escalation roster + Mythium retirement note) + §4.6a Auxiliary economy NEW (7-slot universal catalog: Damage Bonus / Economy Bonus / Tower-count expansion / Send-Creeps / Send-for-Interest / Call-for-Help / Maze Stone + currency-budget audit + 1.725× expert-stack cross-link). §4.10.1 (s) + §4.10.7 forward-anchors from Round 3 now resolve live. Phase-4 trimmed to 600 lines exactly. cascade-lint clean. §2.4a + §5.4 [LOCKED] untouched. 1 new decision document. Prior: 0.51 — Round 4 phase-4 §4.11 Numbers floor body populated in-place (placeholder → 8 sub-sections binding HP curve `100·1.16^R` + boss ×3/×2/×5 / (k) exponents 1.16/1.19/1.22 / Tribute `5·1.10^R` + lumps 250/400/1500 / speed `f_base=50` + archetype mults / DPS ladder T1=20→God=1080 + tier-up 100/300/900/2500 / commander +15% / 2,880 burst @ 30s CD / once-per-match free tier-up / per-mode N-scaling + R31+ HP×1.5^(R-30) tie-break / skill-bar thresholds 60/75/90 · 50/65/80 · 40/60/80). Cross-references resolve into §4.10.x frame + forward into §4.6a (R5) + phase-6 (R6). cascade-lint pending. §2.4a + §5.4 [LOCKED] + 17-item frame untouched. 1 new decision document. Prior: 0.50 — Round 3 phase-4 §4.10 Tower-vs-Unit math NEW (9 sub-sections binding the 17-item conceptual frame + extension (s) + master damage equation + 7-slot round typology + (k) single-axis rule + skill-bar axes + sell-refund + target-priority + boss/Divinity reward shape + engine-port discipline) + §4.11 Numbers floor placeholder seeded for Round 4. Inserted between §4.9 and §4.8 per §4.4a precedent. Scope decision + §-placement table + 7-round queue filed with 3x debug loop on §-placement (Option C topical 7-round queue chosen over Option A single mega-round + Option B per-decision-file). §-placements locked: phase-3 §3.6 mode-roster (R2); phase-4 §4.10 Tower-vs-Unit math NEW (R3); phase-4 §4.11 Numbers floor NEW (R4); phase-4 §4.6 economy rewrite + §4.6a Auxiliary-economy NEW (R5); phase-4 §4.7 Round-11 hook + phase-6 skill-bar telemetry + phase-7 §7.4 "Go big" non-negotiable (R6); hub CONCEPT.md version bump + phase index touches (R7). Dual-push after R3 / R5 / R7. §2.4a + §5.4 [LOCKED] + 2026-04-25 locked content skeleton untouched. PM autonomy mandate carries forward; Rounds 2-7 autonomous. 1 new decision document. Prior: 0.47 — 2026-05-05: Round 10 (Divinity sources, CLOSES Numbers-phase arc). [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
