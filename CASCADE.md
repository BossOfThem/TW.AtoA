...
*Document version: 0.26 — 2026-04-27 (continuation): Commander-as-summoned-ability-avatar plan-mode pass — steps 1-4 of 8 LANDED (decision filed + 2026-04-20 superseded + reshape-plan C4/C7 amendment + phase-4 §4.1 subsection); steps 5-8 queued (§4.4a Builder + §4.4 redaction; §4.7 historic-arc banner; CASCADE this entry; PROGRESS new session log). Same-day amendment captures 8-Q PM refinement (Aztec pre-contact; round-30 antagonists; Jörmungandr-vs-Fenrir Follow-up #11; §5.4 Lineages-row deletion Follow-up #10). 1 new decisions-table row already at top. §2.4a + §5.4 [LOCKED] untouched. `cascade-lint` clean. Prior: 0.25 — 2026-04-27: doc-hygiene system — PROGRESS-archive.md + CASCADE-history.md created; PROGRESS.md trimmed (50KB→23KB); CASCADE.md trimmed (41KB→16KB); CLAUDE.md Doc hygiene section added; bootstrap ~125KB→~78KB. [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
