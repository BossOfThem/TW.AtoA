...
*Document version: 0.50 — 2026-05-05: CONCEPT amendment pass Round 3 LANDED — phase-4 §4.10 Tower-vs-Unit math NEW (9 sub-sections binding the 17-item conceptual frame + extension (s) + master damage equation + 7-slot round typology + (k) single-axis rule + skill-bar axes + sell-refund + target-priority + boss/Divinity reward shape + engine-port discipline) + §4.11 Numbers floor placeholder seeded for Round 4. Inserted between §4.9 and §4.8 per §4.4a precedent. cascade-lint pending. §2.4a + §5.4 [LOCKED] + 17-item frame untouched. 1 new decision document. Prior: 0.49 — Round 2 phase-3 §3.6 mode roster 5→6. Scope decision + §-placement table + 7-round queue filed with 3x debug loop on §-placement (Option C topical 7-round queue chosen over Option A single mega-round + Option B per-decision-file). §-placements locked: phase-3 §3.6 mode-roster (R2); phase-4 §4.10 Tower-vs-Unit math NEW (R3); phase-4 §4.11 Numbers floor NEW (R4); phase-4 §4.6 economy rewrite + §4.6a Auxiliary-economy NEW (R5); phase-4 §4.7 Round-11 hook + phase-6 skill-bar telemetry + phase-7 §7.4 "Go big" non-negotiable (R6); hub CONCEPT.md version bump + phase index touches (R7). Dual-push after R3 / R5 / R7. §2.4a + §5.4 [LOCKED] + 2026-04-25 locked content skeleton untouched. PM autonomy mandate carries forward; Rounds 2-7 autonomous. 1 new decision document. Prior: 0.47 — 2026-05-05: Round 10 (Divinity sources, CLOSES Numbers-phase arc). [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
