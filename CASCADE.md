...
|------|----------|---------------|
| 2026-04-26 | [Prototype reshape plan (Step C, 6 steps: data layer → silhouettes 5→3 → Tribute/Divinity bar → tier ladder + Fusion menu → RPS indicator → dead-code pass)](decisions/2026-04-26-prototype-reshape-plan.md) — **Proposed**, awaiting PM ratification | Medium |
...
*Document version: 0.25 — 2026-04-27: doc-hygiene system — PROGRESS-archive.md + CASCADE-history.md created; PROGRESS.md trimmed (50KB→23KB); CASCADE.md trimmed (41KB→16KB); CLAUDE.md Doc hygiene section added; bootstrap ~125KB→~78KB. Prior: 0.24 — 2026-04-26 (later, continuation): stages 03 + 07 stub-amendment banners filed (real-cultures cascade completes across stages 01/03/04/05/06/07; 00/02/08 verified frame-independent). [`admin/concept.json`](admin/concept.json) `meta.staleNotice` banner added — file still on pre-2026-04-21 shape; migration tracked as PROGRESS debt pending PM direction. `cascade-lint` clean. §2.4a + §5.4 [LOCKED] untouched. New pointer block at top. Prior: 0.23 — 2026-04-26 (later): Phase 1 exit one-pager LANDED ([`decisions/2026-04-26-phase-1-exit-one-pager.md`](decisions/2026-04-26-phase-1-exit-one-pager.md), Accepted, Reversibility Easy, closes 2026-04-25 Follow-up #11) + phase-2 §2.3 residual bookkeeping + stages 01/04/05/06 stub-amendment banners + CONCEPT-GAPS v0.5 shape-audit re-pass (11 rows all shape-independent, no retirements) + prototype reshape plan filed Proposed ([`decisions/2026-04-26-prototype-reshape-plan.md`](decisions/2026-04-26-prototype-reshape-plan.md), Reversibility Medium, 6-step C1-C6). Working-title "Ash to Altar" stays per PM; "Mud to Myth" floated. §2.4a + §5.4 [LOCKED] untouched. Prototype still frozen pending PM ratification of the reshape plan. New pointer block + 2 new decisions-table rows (phase-1-exit-one-pager, prototype-reshape-plan). [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
