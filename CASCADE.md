...
*Document version: 0.46 — 2026-05-05: Numbers-phase Round 9 LANDED — Skill-bar thresholds. Matchup-correctness / Placement-coverage / Ability-uptime per (k) tier (Hardcore expert 90/80/80, Hard 75/65/60, Easy 60/50/40, novice all-k 30/30/20). Hardcore expert realized stack 0.576 × 1.725× = ~1.0× closes Round 5 Hardcore margin exactly. Telemetry definitions captured for Phase 5 instrumentation. Round 11 mandate: wave-randomization + crystal-lock variance to defend threshold integrity. 1 new decision document. cascade-lint pending. §2.4a + §5.4 [LOCKED] + 17-item frame untouched. Prior: 0.45 — 2026-05-05: Round 8 (per-mode tuning) landed. [Older version history archived to [`CASCADE-history.md`](CASCADE-history.md).]*
