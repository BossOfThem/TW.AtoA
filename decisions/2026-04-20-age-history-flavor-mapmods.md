...
> **Re-rebase banner — added 2026-04-26** (2026-04-25 ratification Follow-up #10). The 2026-04-21 parent is now **Superseded by the 2026-04-24 reopen → 2026-04-25 real-cultures ratification** ([`2026-04-25-q2-real-cultures-direction-ratified.md`](2026-04-25-q2-real-cultures-direction-ratified.md), Reversibility **Hard**). This decision is **re-rebased, not superseded**. Re-rebase delta: the 3-tier Dust / Form / Apotheosis dungeon-cosmology arc dissolves into the **4-tier tower ladder + Fusion endgame** (T1 swarm → T2 mainline → T3 elite → T4 Demigod/Hero → Fusion → God) per `concept/phase-3.md §3.5`; the banner mechanic applies at **Tier Gate transitions** (T1→T2, T2→T3, T3→T4) and at the **Fusion event** (entering the Fusion menu and executing a recipe is a natural God-summoning banner moment — distinct from a tier-gate banner, trailer-beat framing). Banner time recomputes to ~3 Tier Gates × 2.5s + up to 3 Fusion banners × 2.5s = **≤15s across a 30-round match** — still below the 27.5s Loop-1 critique ceiling, well above the 2026-04-21 ~5s floor. **`mapmods.json` data shape survives**; its 6-biome [PROPOSAL] pool is now interpreted per-civ (Greek / Aztec / Norse coloration) at Phase 5. The deferred PvE campaign scope (2026-04-25 Follow-up #8 — AGES concept) is the proper home for any expanded age-as-history treatment; within a match, the tier-gate + Fusion banner model covers the AoE-DNA surfacing. Autosave hook (Campaign-mode writeMatchSave on Tier Gate crossing) survives. `gp.autoAgeUp → gp.autoTierUp` rename is still a prototype-reshape task; 2026-04-25 ratification additionally defers prototype reshape as post-launch / deferred scope (prototype frozen). Banner is bookkeeping; Accepted status stands.
