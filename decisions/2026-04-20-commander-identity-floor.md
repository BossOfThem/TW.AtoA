...
> **Re-rebase banner — added 2026-04-26** (2026-04-25 ratification Follow-up #10). The 2026-04-21 parent is now **Superseded by the 2026-04-24 reopen → 2026-04-25 real-cultures ratification** ([`2026-04-25-q2-real-cultures-direction-ratified.md`](2026-04-25-q2-real-cultures-direction-ratified.md), Reversibility **Hard**). This decision is **re-rebased, not superseded**. Re-rebase delta: the 3-lineage Ash / Nature / Prayer shape dissolves into **3 civilizations (Greek / Aztec / Norse)**; the "lineage tilt +15%" component becomes **civilization affinity** — each commander plays only their own civ's roster at launch (stronger cage than tilt, per `concept/phase-3.md §3.2`); cross-civ borrowing parked as the future Foresight-coin mechanic. The 3-commander launch roster stays 3, now **Leonidas (Greek) / Montezuma II (Aztec) / Ragnar Lothbrok (Norse)** with all 9 ability names locked 2026-04-25 ("high-school recognizable" convention check passed). Voice-line floor (12 [PROPOSAL]) now carries a cultural-sensitivity-pass gate (2026-04-25 Follow-up #5) for VO direction. Portrait / silhouette / signature / passive / progression ladder (20 [PROPOSAL]) / 3 cosmetic slots survive unchanged. See `concept/phase-4.md §4.1` for the cascaded amendment. Banner is bookkeeping; Accepted status stands.
