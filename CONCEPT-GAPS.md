...
| **ECON-04** | No auxiliary economy structure specified. CONCEPT silent on currency-creation mechanics beyond per-kill Tribute drops. | Silent. | Squadron TD send-creeps-for-income; BTD6 Knowledge tree; Element TD research; Legion TD 2 Mercenaries. | RATIFIED 2026-05-04 (Rounds 6 + 12) — modular slot system, mode-aware content, Tribute (tactical) + Divinity (strategic) split, in-match side-panel UX, Send-Creeps as 3-mode mechanic (PvE-MP Lane-Trade / PvP-IW Send-for-Interest / PvP-Maze Send-Through-Maze). See decision chain `2026-05-04-round-6-aux-economy-ratifications.md` → `2026-05-04-round-12-aux-ux-frame-extension.md`. | Blocks-vision (RESOLVED) | 3 + 4 |
| **MODE-01** | Game-modes ontology under-specified. CONCEPT.md §3.6 names "Solo / Co-op Horde / Lane Wars / PvE Campaign" but does not specify mode-gated mechanics, lane topology per mode, or per-mode balance scaling rules. | §3.6 mode names only. | BTD6 mode roster (Standard / Sandbox / Race / Boss / Co-op / Apopalypse / Daily); Line Tower Wars maze model; Legion TD 2 mode list. | RATIFIED 2026-05-04 (Rounds 7-11) — **6-mode first-class roster** (expanded from 5): Solo Campaign · Horde-A Lane Defense · Horde-B Shared Front · PvE Multiplayer · PvP Interest Wars · PvP Maze. Per-mode lane topology / lives / aux-slot enablement / send-variants / win-condition all locked. See decision chain `2026-05-04-round-7-solo-campaign-deep-dive.md` → `2026-05-04-round-11-pvp-maze-deep-dive.md`. | Blocks-vision (RESOLVED) | 3 + 4 |
