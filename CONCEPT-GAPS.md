...
**2026-04-26 shape-audit re-pass (post real-cultures ratification + attack-type mapping).** The 2026-04-21 parent tightening is **Superseded** by [`decisions/2026-04-25-q2-real-cultures-direction-ratified.md`](decisions/2026-04-25-q2-real-cultures-direction-ratified.md) (Reversibility Hard) and the cascade is captured in [`decisions/2026-04-26-phase-1-exit-one-pager.md`](decisions/2026-04-26-phase-1-exit-one-pager.md). New shape: **3 civilizations (Greek/Aztec/Norse) + 3 launch commanders + 4-tier ladder + Fusion endgame + 7-type × 5-armor attack matrix**. Re-audit of the 11 remaining rows: **none reference the civ-count, tier-count, Fusion-recipe-count, or attack-type-count, and none require retirement.** All eleven remain shape-independent. CMDR-03 arithmetic holds (3 civs × 3 commanders × 1 cosmetic per slot × 3 slots = 9 cosmetic items at launch — same number as 2026-04-21, different derivation). One new consideration surfaces and does NOT create a new row: the **cultural-sensitivity pass** (2026-04-25 Follow-up #5) is a mandatory gate for any content-lock, including cosmetic items for the 3 commanders; CMDR-03's cosmetic-slot count is therefore gated on that pass. This is tracked in the ratification Follow-ups, not as a new CONCEPT-GAPS row — it applies game-wide, not to CMDR-03 specifically. Active gap count unchanged at 11.
...
| **ECON-04** | No auxiliary economy structure specified. CONCEPT silent on currency-creation mechanics beyond per-kill Tribute drops. | Silent. | Squadron TD send-creeps-for-income; BTD6 Knowledge tree; Element TD research; Legion TD 2 Mercenaries. | Adopt mode-aware **modular auxiliary structure** (separate building / panel / system) hosting targeting overrides, build-queue, tower-count expansion, level/upgrade/fusion choice surface, damage bonus, economy bonus, send-troops-to-PvP-lane, call-for-help, maze stone, send-for-Interest. Mode-gating per slot family. Currency interface TBD (Tribute? Divinity? third currency Influence/Foresight-coin?). Round 6+ AskUserQuestion ratification ongoing per [`decisions/2026-05-04-auxiliary-economy-and-modes-scope.md`](decisions/2026-05-04-auxiliary-economy-and-modes-scope.md). | Blocks-vision | 3 + 4 |
| **MODE-01** | Game-modes ontology under-specified. CONCEPT.md §3.6 names "Solo / Co-op Horde / Lane Wars / PvE Campaign" but does not specify mode-gated mechanics, lane topology per mode, or per-mode balance scaling rules. | §3.6 mode names only. | BTD6 mode roster (Standard / Sandbox / Race / Boss / Co-op / Apopalypse / Daily); Line Tower Wars maze model; Legion TD 2 mode list. | Adopt **5-mode first-class roster**: (1) Solo Campaign single-lane (k)-tiered; (2) Horde Co-op 2-8 player team-mode with player-count scaling; (3) PvE Multiplayer 8 identical lanes last-alive; (4) PvP Interest Wars Lane send-creeps + interest-from-sends 15-30s rounds; (5) PvP Maze Lane towers-create-path Line-TW-style. Each mode declares lane topology, win condition, auxiliary-structure surface, currency interface. Round 6+ ratification per [`decisions/2026-05-04-auxiliary-economy-and-modes-scope.md`](decisions/2026-05-04-auxiliary-economy-and-modes-scope.md). | Blocks-vision | 3 + 4 |
| **MATH-01** | Tower-vs-unit damage equation under-specified at concept level. No canonical form for damage-delivered, no formal engagement-time integral, no commander effect-type taxonomy, no skill-bar operationalization. Numbers cannot be tuned without the equation. | Silent (only `effectiveTowerStats` collapsed scalar in prototype). | Generic TD literature: DPS-integral form is the genre standard. | RATIFIED 2026-05-04 — see [`decisions/2026-05-04-balance-pass-1-conceptual-frame.md`](decisions/2026-05-04-balance-pass-1-conceptual-frame.md) (17-item conceptual frame). Numbers-phase Follow-up #13 consumes frame. | Blocks-MVP (RESOLVED) | 4 + 5 |
...
*Document version: 0.5 — 2026-04-26 shape-audit re-pass. Parent 2026-04-21 tightening **Superseded** by [2026-04-25 real-cultures ratification](decisions/2026-04-25-q2-real-cultures-direction-ratified.md); cascade captured in [2026-04-26 Phase 1 exit one-pager](decisions/2026-04-26-phase-1-exit-one-pager.md). Audit of the 11 remaining rows against the new shape (3 civs / 3 commanders / 4-tier ladder / Fusion endgame / 7-type × 5-armor matrix) confirms none reference civ-count, tier-count, Fusion-recipe-count, or attack-type-count; none require retirement. Active gap count unchanged at 11. CMDR-03 cosmetic arithmetic unchanged (9). Cultural-sensitivity pass (Follow-up #5) flagged as game-wide mandatory gate but does not create a new row. Prior: v0.4 — 2026-04-21 shape-audit pass. v0.3 — 2026-04-20 (SAVE-01 + SAVE-02 ratified); 16 of 26 rows migrated; 11 remain (2 Blocks-launch, 3 Blocks-MVP, 6 Post-launch-ok).*
