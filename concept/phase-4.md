...
*→ active drill-down: [stage 06 — hybrids & fusion](../stages/06-hybrids-fusion.md). **Shape locked 2026-04-25** per [`decisions/2026-04-25-q2-real-cultures-direction-ratified.md`](../decisions/2026-04-25-q2-real-cultures-direction-ratified.md). **Specific numerics LOCKED 2026-05-06** per [`Fusion-numerics balance-pass ratification`](../decisions/2026-05-06-fusion-numerics-balance-pass-ratification.md) (cross-coherence audit composing per-tower R2-R4 9-God row authoring + per-civ RN three-civ-three-equation-form fingerprint + Economy paper-balance Divinity-cadence; 36-cell row × locked-Fusion-shape verification + R30-boss-clear cumulative-DPS sanity + 45-cell three-civ-fingerprint at God tier; zero cascade-violations). **Divinity balance LOCKED 2026-05-05** Numbers-phase #13 R10 + 2026-05-06 [`Economy paper-balance ratification`](../decisions/2026-05-06-economy-paper-balance-ratification.md).*
...
- ✅ **Fusion system shape signed off** (done 2026-04-25: 9 locked Gods via 9 locked 2-Demigod recipes, Divinity-gated, menu-driven discovery). **Fusion-numerics balance-pass DONE 2026-05-06** per [`Fusion-numerics balance-pass ratification`](../decisions/2026-05-06-fusion-numerics-balance-pass-ratification.md). 3-check cross-coherence audit at zero cascade-violations: (1) Per-God row × locked-Fusion-shape verification across 9 Gods × 4 anchors (recipe / 2-type pair / DPS ±20% band / Divinity-cadence) = 36/36 cells; (2) Cumulative-team-DPS R30-boss-clear sanity at Hardcore-expert realized — 3-Fusion stack delivers ~25% kill-time reduction (51.7s vs 69.3s no-fusion counterfactual at 327,490 HP final boss); (3) Three-civ fingerprint preservation at God tier across 3 civs × 3 Gods × 5 fingerprint-loci = 44/45 expression cells (single non-expression = Norse Odin L1, locked-input resolution of Norse Divine-pre-T4 type-hole per 2026-04-25 multi-civ-future commitment, not a violation) + cross-civ orthogonality at 4-aggregate-signal level (cd-band / range-band / DPS-aggregate / status_proc-kind primary all falsifiably distinct). Built on locked Numbers-phase #13 R5 + R9 + R10 magnitudes + per-tower R2-R4 9-God row authoring + per-civ RN fingerprint lock + Economy paper-balance Divinity-cadence; no new design surface; no fresh per-row magnitudes authored.
...
- ✅ **Economy balanced on paper** (Tribute + Divinity income curves, per-tier tower costs, Fusion spend cadence). **DONE 2026-05-06** per [`Economy paper-balance ratification`](../decisions/2026-05-06-economy-paper-balance-ratification.md). 3-check cross-coherence audit at zero cascade-violations: (1) Tribute spend-vs-income at Easy-on-curve (~25,000 T income / ~10,700 T placement / ~12,400 T headroom); (2) Divinity spend-vs-income across realistic-Easy / realistic-expert / theoretical-ceiling envelopes (4-cap / 6-cap / 8→6-with-wastage all balanced); (3) §4.11.8 Hardcore-expert realized math closes to 1.0 exactly (0.576 × 1.20 × 1.15 × 1.25 ≈ 0.993). Built on locked Numbers-phase #13 R1-R10 magnitudes; no new design surface.
- ✅ **Monetization model specifics resolved** (cosmetic-only; no-pay-to-win non-negotiable). **DONE 2026-05-06** per [`Monetization specifics ratification`](../decisions/2026-05-06-monetization-specifics-ratification.md). 4-check cross-coherence audit at zero cascade-violations: (1) DRG-reference structural alignment (6/6 elements match: premium base + free BP + premium BP cosmetic-only + cosmetic DLC + no lootboxes + no gameplay-advantage); (2) Aux economy ≠ monetization surface (7/7 aux slots gated on in-match Tribute/Divinity, never premium currency); (3) Commander cosmetic-slot floor preserves no-p2w (every paid surface UI/visual/audio additive, every gameplay surface XP-only); (4) Phase 7.4 identity-constraint resilience (4 canonical pressure-source attacks defended by structural locks). Model-shape Hard-reversibility; commercial price-point selection within $5-15 envelope + BP cadence + cosmetic DLC catalog cadence are PM-decisional Easy-reversibility surface that does not reopen the model.
- Engine choice locked (leading: Godot 4 per `concept/phase-5.md §5.5`).
- Art director engaged or scoped.
- ✅ **Cultural-sensitivity pass scheduled** — 2026-04-25 Follow-up #5 gate landed before any Phase 5 content lock touches Aztec representation, Leonidas visual framing, or Ragnar TV-vs-history framing. **DONE 2026-05-06** per [`Cultural-sensitivity Phase-4-exit gate ratification`](../decisions/2026-05-06-cultural-sensitivity-phase-4-exit-gate-ratification.md). 3-check audit at zero cascade-violations: (1) 13-touchpoint binding-coverage across 4 spine docs (every content-lock-adjacent surface cites the gate as blocking pre-condition); (2) gate scope bounded at 3 named consultation requirements (Aztec representation pre-contact-only per 2026-04-27 8-Q amendment / Leonidas 300-movie-ideology audit / Ragnar TV-vs-history framing); (3) hard-gate enforcement verified blocking-not-advisory at every reference (no skippable / post-hoc / advisory framing anywhere in cascade). Phase-4 exits with schedule binding; pass-execution sits Phase-5 sprint pre-art-lock per §5.5 + §7.4. Reversibility Hard for gate body / Easy for execution surface.
